...
You can start writing assets in `spaceship_dagster/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `spaceship_dagster_tests` directory and you can run tests using `pytest`:

```bash
pytest spaceship_dagster_tests
```
